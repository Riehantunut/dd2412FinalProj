...
if __name__ == "__main__":
    print("INTERPOLATING: MLPs TRAINED ON MNIST WITH SGD")

    model_A = torch.load("models/mlp_mnist_sgd_model_3.pth")
    model_B = torch.load("models/mlp_mnist_sgd_model_4.pth")
    ...
    file_name = dir_name + '/data/mlp_mnist_sgd/run_'
    ...
    # plt.xlabel("steps")
    # plt.title(
    #     "Interpolation between MLPs trained on MNIST with the SGD optimizer")
    # plt.savefig("plots/interpolation_mlp_MNIST_sgd.pdf")
