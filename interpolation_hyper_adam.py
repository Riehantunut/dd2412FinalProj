...
if __name__ == "__main__":
    ...
    # 1,4 andra
    model_A = torch.load(
        "models/kmnist_adam/mlp_KMNIST_Adam_model_5999_lr0dot0007_0_.pth")
    model_B = torch.load(
        "models/kmnist_adam/mlp_KMNIST_Adam_model_5999_lr0dot0007_1_.pth")
    ...
    data_to_save['hyper'] = 0.0007

    dir_name = os.path.dirname(absolute_path)
    file_name = dir_name + '/data/hyper_adam/run_'
