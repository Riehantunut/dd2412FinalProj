...
if __name__ == "__main__":
    print("INTERPOLATING: MLPs TRAINED ON KMNIST WITH SGD")

    # 1,3 är på första fliken
    # 1,4 andra
    model_A = torch.load(
        "models/kmnist_SGD/mlp_KMNIST_SGD_model_5999_lr0dot005_m1dot0_0_.pth")
    model_B = torch.load(
        "models/kmnist_SGD/mlp_KMNIST_SGD_model_5999_lr0dot005_m1dot0_2_.pth")
    ...
    data_to_save['hyper'] = [0.005, 1.0]

    dir_name = os.path.dirname(absolute_path)
    file_name = dir_name + '/data/hyper_sgd/run_'
